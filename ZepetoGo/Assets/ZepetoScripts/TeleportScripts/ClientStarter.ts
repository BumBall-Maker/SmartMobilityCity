...
export default class ClientStarter extends ZepetoScriptBehaviour {
    ...
    public static m_Instance : ClientStarter;
    public static Instance():ClientStarter{
    ...
    Awake() {
        if(null == ClientStarter.m_Instance)
        {
            ClientStarter.m_Instance = this;
    ...
    private OnJoinPlayer(sessionId: string, player: Player) {
        ...
        spawnInfo.position = new UnityEngine.Vector3(-93.4309998,6.71799994,-46.2470016);
